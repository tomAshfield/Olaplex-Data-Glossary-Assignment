...
# Project Overview
st.write("""
Welcome to the OLAPLEX Data Glossary! This interactive glossary is designed to provide clear, accessible explanations of key business and technical terms, making it easy for team members across departments to understand and work with data-related concepts.
...
- **Accessibility:** Make data-related terms and metrics easily understandable for non-technical users.
- **Clarity:** Provide clear business definitions with optional technical details for deeper understanding.
- **Scalability:** Lay the groundwork for a resource that can grow with OLAPLEX's evolving data needs.
...
st.write("""
- Use the search bar to find specific terms or metrics.
